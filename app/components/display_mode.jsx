...
const ToggleContainer = styled(Button)`
  ...
  outline: none;
  background: none;
  box-shadow: -1px -0.3px 3px ${({ theme }) => theme.light},
    3px 0.3px 3px ${({ theme }) => theme.shadow},
    inset 0.2px 0.2px 0.1px ${({ theme }) => theme.shadow },
    inset 0.3px 0px 1px ${({ theme }) => theme.shadow};
